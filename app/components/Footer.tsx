...
const Footer = () => {
  return (
    <footer className="py-7 border-theme !border-0 !border-t">
        ...
        <div className="flex-center gap-2 ms-4">
          <a href="https://github.com/deepak252" target="_blank">
            <Image
              src={GithubImg}
              alt="github"
              className="size-10 me-2 dark:invert"
            />
          </a>
          <a
            ...
            target="_blank"
          >
            <Image src={LinkedInImg} alt="linkedin" className="size-10" />
          </a>
          <a href="https://leetcode.com/u/deepakchaurasiya/" target="_blank">
            <Image src={LeetcodeImg} alt="leetcode" className="size-10" />
          </a>
        </div>
      </div>
    </footer>
